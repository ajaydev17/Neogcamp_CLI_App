...
console.table(highScore.highScores);


// find the high score
let maxScore = highScore.highScores[0].score;

for (var i = 0; i < highScore.highScores.length; i++) {
    if (highScore.highScores[i].score > maxScore) {
        maxScore = highScore.highScores[i].score;
    }
}
